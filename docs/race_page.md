...
| `services/rowing_utils.py` | `is_rankable_noninterval()`, `apply_quality_filters()`, `RANKED_DISTANCES`, `RANKED_TIMES`, `get_season()`, `apply_best_only()`, `compute_pace()`, `compute_watts()`, `age_from_dob()`, `profile_complete()` |
